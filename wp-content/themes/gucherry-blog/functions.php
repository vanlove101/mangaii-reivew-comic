...
add_action( 'wp_enqueue_scripts', 'gucherry_custom_scripts' );
...
function gucherry_blog_scripts() {
	...
	if ( ! is_singular() ) {
		...
		global $wp_query;
		wp_register_script( 'gucherry-blog-jquery-script', 'https://ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js', array( 'jquery' ), wp_get_theme()->get( 'Version' ), true );
		...
		wp_register_script( 'gucherry-blog-single-script', get_template_directory_uri() . '/everestthemes/assets/dist/js/single.js', array( 'jquery' ), wp_get_theme()->get( 'Version' ), true );
